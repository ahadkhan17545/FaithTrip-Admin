(() => {
    ...
    function Ut(e) {
        T = e.reactive, L = e.release, N = t => e.effect(t, {
            scheduler: r => {
                ot ? Vt(r) : r()
            }
        }), st = e.raw
    ...
    function Jt() {
        Gt && v("Alpine has already been initialized on this page. Calling Alpine.start() more than once can cause problems."), Gt = !0, document.body || v("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"), U(document, "alpine:init"), U(document, "alpine:initializing"), le(), rr(t => S(t, O)), ee(t => ce(t)), Ce((t, r) => {
            ue(t, r).forEach(n => n())
        });
...
`:""}`, t), setTimeout(() => {
    ...
    function In(e, t, r) {
        ...
        return (i = () => {}, {
            ...
            if (typeof n == "function") {
                ...
                n.finished ? (De(i, n.result, a, s, r), n.result = void 0) : c.then(l => {
                    De(i, l, a, s, r)
    ...
    function Dn(e, t) {
        ...
        Re(e, t.original, o);
        let s = () => {
            e._x_ignore || e._x_ignoreSelf || (n.inline && n.inline(e, t, i), n = n.bind(n, e, t, i), bt ? pe.get(hr).push(n) : n())
        };
    ...
    function ge(e, t, r, n = []) {
        switch (e._x_bindings || (e._x_bindings = T({})), e._x_bindings[t] = r, t = n.includes("camel") ? Zn(t) : t, t) {
            case "value":
                qn(e, r);
                break;
            case "style":
    ...
    function $r(e, t) {
        ...
        Y[e] = t, typeof t == "object" && t !== null && t.hasOwnProperty("init") && typeof t.init == "function" && Y[e].init(), Ne(Y[e])
    }
    ...
    function nn(e = !1, t = !1) {
        return function(n, i, o) {
            ...
            return (Ve(i) ? rn.has(i) : di(i)) || (e || M(n, "get", i), t) ? a : Dt(a) ? !s || !qe(i) ? a.value : a : be(a) ? e ? ln(a) : Qe(a) : a
        }
    }
    var _i = gi();
    ...
    d("model", (e, {
        ...
        e._x_model = {
            ...
            m === void 0 && typeof r == "string" && r.match(/\./) && (m = ""), window.fromModel = !0, h(() => ge(e, "value", m)), delete window.fromModel
        }, n(() => {
            let m = c();
    ...
    function Wi(e, t, r, n) {
        ...
        r(s => {
            ...
            for (let f = 0; f < m.length; f++) {
                let [g, b] = m[f], E = a[g], A = a[b], Z = document.createElement("div");
                h(() => {
                    A || v('x-for ":key" is undefined or invalid', o), A.after(Z), E.after(A), A._x_currentIfEl && A.after(A._x_currentIfEl), Z.before(E), E._x_currentIfEl && E.after(E._x_currentIfEl), Z.remove()
            ...
            for (let f = 0; f < p.length; f++) {
                ...
                P(ae, Ht, o), ae._x_refreshXForScope = wn => {
                    ...
                    E.after(ae), S(ae)
                }), typeof Z == "object" && v("x-for key cannot be an object, it must be a string or an integer", o), a[Z] = ae
            }
