        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0" style="font-size: 18px">View All Banners</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <label id="customFilter">
                                <a href="{{url('add/new/banner')}}" style="margin-left: 5px" class="btn btn-success btn-sm"><b><i class="fas fa-plus"></i> Add New Banner</b></a>
                            </label>
