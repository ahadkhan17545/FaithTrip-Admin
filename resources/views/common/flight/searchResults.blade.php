            ...
            @if (count($searchResults) > 0)
                        ...
                        <div class="col-lg-4">
                            <div class="badge bg-primary fs-16 mb-2 mb-lg-0">
                                ...
                                <span class="font-weight-500">
                                    <b id="total_flights">{{ count($searchResults) }}</b>
                                </span>
                                Flights found
                            </div>
                        </div>
                ...
                <div class="row">
                                        ...
                                        <div class="accordion-item">
                                                ...
                                                <div class="col-md-10 col-sm-12">
                                                    <div class="fs-15">
                                                        ...
                                                        <span class="ml-1">
                                                            ...
                                                            {{ $searchResults[0]['departure_airport_name'] }},
                                                            {{ $searchResults[0]['departure_city_name'] }},
                                                            ({{ $searchResults[0]['departure_country_name'] }})
                                                            <i class="fas fa-plane-departure"></i>
                                                            {{ $searchResults[0]['arrival_airport_name'] }},
                                                            {{ $searchResults[0]['arrival_city_name'] }}
                                                            ({{ $searchResults[0]['arrival_country_name'] }})
                                                            <i class="fa fa-calendar" aria-hidden="true"></i>
                                                            {{ date('d-m-Y', strtotime($searchResults[0]['departure_datetime'])) }}
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body" style="padding: 0">
                                                    @include('common.flight.modifySearchResults')
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @foreach ($searchResults as $index => $data)
                                    ...
                                    @if ($minPrice && $minPrice > 0 && (!$maxPrice && $maxPrice == 0))
                                        @if ($totalPrice >= $minPrice)
                                            @if (session('airline_carrier_code') && in_array($data['operating_carrier_code'], session('airline_carrier_code')))
                                                @include('common.flight.resultRow')
                                            @endif
                    ...
                    <div class="col-md-3 d-none d-lg-block leftSidebar mb-3">
                        <div class="theiaStickySidebar">
                            @include('common.flight.filterSearchResults')
                        </div>
                    </div>
