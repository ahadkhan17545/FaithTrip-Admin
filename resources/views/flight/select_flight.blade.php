                        ...
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="col-12 col-md-8 mb-2 mb-sm-3">
                                    <input name="traveller_name" type="text" class="form-control"
                                        placeholder="Traveller Name" required="">
                                </div>
                            </div>
                            <div class="form-row">
                                <div
                                ...
                                <div class="col-12 col-md-8 mb-2 mb-sm-3">
                                    <input name="traveller_email" type="email" class="form-control"
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-12 col-md-8 mb-2 mb-sm-3">
                                    <input name="traveller_contact" type="text" class="form-control"
                                        placeholder="+8801*********" required="">
                                </div>
                            </div>
                            ...
                            @foreach ($revlidatedData['groupedItineraryResponse']['itineraryGroups'][0]['itineraries'][0]['pricingInformation'][0]['fare']['passengerInfoList'] as $passengerInfoList)
                                @for ($i = 1; $i <= $passengerInfoList['passengerInfo']['passengerNumber']; $i++)
                                    <hr>
                                    <h6 class="fw-bold">Please fill the information for
                                        {{ $passengerInfoList['passengerInfo']['passengerType'] }} - {{ $i }}
                                    </h6>
                                    <input type="hidden" name="passanger_type[]"
                                        value="{{ $passengerInfoList['passengerInfo']['passengerType'] }}">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-12 col-md-8 mb-3 mb-sm-3">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <input required="" name="document_expire_date[]" type="date"
                                                        class="form-control">
                                                </div>
                                                <div class="col-md-6">
                                                    <select required="" name="document_issue_country[]"
                                                        ...
                                                        <option value="KGZ">Kyrgyzstani, Kyrgyz, Kirgiz, Kirghiz
                                                        </option>
                                                        ...
                                                        <option value="SGS">South Georgia or South Sandwich Islands
                                                        </option>
                                                        ...
                                                        <option value="WLF">Wallis and Futuna, Wallisian or Futunan
                                                        </option>
