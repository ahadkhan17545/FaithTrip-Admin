                                        ...
                                        <div class="dropdown travellers-dropdown" id="dropdown-oneway">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                <div class="tab-container">
                                                    ...
                                                    <div class="class-type mt-2">
                                                        <div class="custom-control custom-radio pl-0">
                                                            <input type="radio" id="economy1" name="classType1" class="custom-control-input economy1" checked />
                                                            <label class="custom-control-label fs-16 font-weight-500" for="economy1">Economy</label>
                                                        </div>
                                                        <div class="custom-control custom-radio pl-0">
                                                            <input type="radio" id="premiumEconomy1" name="classType1" class="custom-control-input premiumEconomy1" />
                                                            <label class="custom-control-label fs-16 font-weight-500" for="premiumEconomy1">Premium economy</label>
                                                        </div>
                                                        <div class="custom-control custom-radio pl-0">
                                                            <input type="radio" id="first1" name="classType1" class="custom-control-input first1" />
                                                            <label class="custom-control-label fs-16 font-weight-500" for="first1">First</label>
                                                        </div>
                                                        <div class="custom-control custom-radio pl-0">
                                                            <input type="radio" id="business1" name="classType1" class="custom-control-input business1" />
