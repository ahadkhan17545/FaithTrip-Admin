                            ...
                            <div class="search-row row no-gutters position-relative mx-0 mb-4">
                                <div class="col-lg-6 px-0">
                                    <div class="input-group rounded">
                                        ...
                                        <select class="round-trip-from-option form-control border-bottom-0 border-right select2"
                                            id="round-trip-from-option" name="from_airport_name" required tabindex="-1"
                                            aria-hidden="true">
                                            <option value="DAC">
